"""Run bounded Q3 12/18/24-hour representative-day experiments."""
...
def main(argv=None):
    ...
    parser.add_argument("--output-dir", type=Path, default=ROOT / "Q3" / "analysis")
    ...
    for day in args.dates:
        for hours in HORIZON_HOURS:
            ...
            records.append({"question": "Q3", "date": day, "horizon_hours": hours,
                **summarize_result(result, day), "backend": "event-policy",
                "n_scenarios": args.scenarios})
            print(f"Q3 {day} H={hours}h complete", flush=True)
    csv_path, json_path = write_records(records, args.output_dir)
    plot_horizon_sensitivity(records, args.output_dir, "Q3 12/18/24小时前瞻敏感性")
