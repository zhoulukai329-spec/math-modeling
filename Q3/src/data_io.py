"""Exact, timestamp-safe readers for Question 3 input workbooks.
...
class InputData:
    """All Q3 inputs, with actual load/PV already converted to kWh/interval."""
...
def load_inputs(
    ...
    """Read Q3 attachments exactly, preserving their original row/column order.
