...
from dispatch_core.plotting import make_solution_figures, plot_revision_sensitivity
...
def main(argv=None):
    ...
    parser.add_argument("--revision-sensitivity", type=Path,
                        default=ROOT / "Q3/analysis/experiments.csv")
    ...
    if args.revision_sensitivity.exists():
        paths += plot_revision_sensitivity(args.revision_sensitivity, args.output_dir)
