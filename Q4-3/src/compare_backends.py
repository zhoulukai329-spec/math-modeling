"""Compare Q4-3 rolling MILP and event policy on bounded intervals."""
...
def main(argv=None):
    ...
    p.add_argument("--output-dir", type=Path, default=ROOT / "Q4-3" / "analysis")
    ...
    for day in args.dates:
        ...
        rows.append(comparison_row("Q4-3", day, args.horizon_hours,
                                   summaries["rolling-milp"], summaries["event-policy"]))
        print(f"Q4-3 backend comparison complete: {day}", flush=True)
